<x-app-layout>
    ...
    <div class="min-h-screen bg-slate-950 pb-24 lg:pb-0" x-data="{}" x-cloak>
        ...
        <div class="lg:ml-[72px] flex flex-col h-screen lg:h-screen">
            ...
            {{-- Chat Messages --}}
            <div id="chatMessages" class="flex-1 flex flex-col overflow-y-auto px-4 sm:px-6 lg:px-8 py-6 space-y-5 max-w-4xl mx-auto w-full">
                {{-- Welcome Message --}}
                <div class="flex items-start mb-auto gap-3 animate-fade-up">
