<x-app-layout>
    ...
    <div class="min-h-screen bg-slate-950 pb-24 lg:pb-8"
         x-data="fluidDashboard()" x-cloak>

        {{-- ============================================
             1. DYNAMIC ALERT BAR
             Color shifts: green → yellow → red
             ============================================ --}}
        <div class="alert-pulse relative overflow-hidden"
             :class="{
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 flex items-center justify-center gap-2 relative z-10">
        ...
        <div class="lg:ml-[72px]">
            ...
            <section class="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950">
                ...
                <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-10 sm:pt-10 sm:pb-14">
                    ...
                    <div class="mt-6 sm:mt-8 animate-fade-up stagger-2">
                        <form action="{{ route('ai-assist.index') }}" method="GET" class="relative max-w-2xl">
                            <div class="search-glow rounded-full bg-white/[0.06] backdrop-blur-xl shadow-card border border-white/10 flex items-center transition-all duration-300 hover:bg-white/[0.09]">
                                {{-- AI sparkle icon --}}
                                <div class="pl-5 pr-2 flex items-center">
                                    <div class="w-9 h-9 rounded-full bg-gradient-to-br from-primary-400 to-emerald-500 flex items-center justify-center shadow-sm">
                                ...
                                <input
                                    type="text"
                                    name="q"
                                    placeholder="Tanya AI: Bagaimana cara evakuasi saat gempa?"
                                ...
                                />
                                <button type="submit" class="mr-3 px-5 py-2.5 bg-gradient-to-r from-primary-500 to-emerald-500 text-white text-sm font-semibold rounded-full hover:shadow-lg hover:scale-[1.02] transition-all duration-200 active:scale-[0.98]">
                                    Tanya
                                </button>
                            </div>
                        </form>
                ...
                {{-- Rounded bottom --}}
                <div class="absolute bottom-0 left-0 right-0 h-6 bg-gradient-to-b from-transparent to-slate-950 rounded-t-3xl"></div>
            </section>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10 mt-2">
                ...
                <section class="animate-fade-up stagger-2">
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 stagger-children">
                        {{-- AI Assistant --}}
                        <a href="{{ route('ai-assist.index') }}" class="quick-action group card-fluid bg-white/[0.04] border border-white/[0.06] rounded-2xl p-5 shadow-card text-center cursor-pointer hover:bg-white/[0.08] transition-all duration-300">
                            <div class="w-12 h-12 mx-auto rounded-2xl bg-gradient-to-br from-primary-100 to-emerald-100 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
                        ...
                        {{-- Peta Bencana --}}
                        <a href="{{ route('map.index') }}" class="quick-action group card-fluid bg-white/[0.04] border border-white/[0.06] rounded-2xl p-5 shadow-card text-center cursor-pointer hover:bg-white/[0.08] transition-all duration-300">
                            <div class="w-12 h-12 mx-auto rounded-2xl bg-gradient-to-br from-sky-100 to-blue-100 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
                        ...
                        {{-- Edukasi --}}
                        <a href="{{ route('guides.index') }}" class="quick-action group card-fluid bg-white/[0.04] border border-white/[0.06] rounded-2xl p-5 shadow-card text-center cursor-pointer hover:bg-white/[0.08] transition-all duration-300">
                            <div class="w-12 h-12 mx-auto rounded-2xl bg-gradient-to-br from-amber-100 to-yellow-100 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
                        ...
                        {{-- Notifikasi --}}
                        <a href="{{ route('articles.index') }}" class="quick-action group card-fluid bg-white/[0.04] border border-white/[0.06] rounded-2xl p-5 shadow-card text-center cursor-pointer hover:bg-white/[0.08] transition-all duration-300">
                            <div class="w-12 h-12 mx-auto rounded-2xl bg-gradient-to-br from-rose-100 to-pink-100 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
                ...
                <section class="animate-fade-up stagger-3">
                    <div class="flex items-center justify-between mb-5">
                        ...
                        <a href="{{ route('guides.index') }}" class="text-sm text-emerald-400 hover:text-emerald-300 font-semibold transition-colors flex items-center gap-1 group">
                            Lihat semua
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5 stagger-children">
                        {{-- Card: Tsunami --}}
                        <div class="card-fluid bg-white/[0.04] border border-white/[0.06] rounded-2xl shadow-card overflow-hidden group hover:bg-white/[0.07] transition-all duration-300">
                            <div class="flex flex-col sm:flex-row">
                                <div class="sm:w-2/5 relative overflow-hidden">
                                    <div class="aspect-[3/2] sm:aspect-auto sm:h-full">
                                        <img src="{{ asset('images/dashboard/tsunami.png') }}" alt="Tsunami" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                                    </div>
                                ...
                                <div class="sm:w-3/5 p-5 sm:p-6 flex flex-col justify-center">
                                    <h3 class="font-bold text-white text-base sm:text-lg group-hover:text-emerald-400 transition-colors">Tsunami</h3>
                                    <p class="text-sm text-slate-400 leading-relaxed mt-2 line-clamp-2">Tsunami umumnya disebabkan oleh gempa bumi bawah laut. Pelajari cara evakuasi dan tanda-tanda alam sebelum tsunami.</p>
                                    <p class="text-xs text-slate-500 mt-2">Diperbarui: 6 Juni 2025</p>
                                    <a href="{{ route('guides.index') }}" class="inline-flex items-center gap-1.5 text-sm text-emerald-400 font-semibold mt-3 hover:text-emerald-300 transition-colors group/link">
                                        Lihat Selengkapnya
                                        <svg class="w-4 h-4 group-hover/link:translate-x-0.5 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-fluid bg-white/[0.04] border border-white/[0.06] rounded-2xl shadow-card overflow-hidden group hover:bg-white/[0.07] transition-all duration-300">
                            <div class="flex flex-col sm:flex-row">
                                <div class="sm:w-2/5 relative overflow-hidden">
                                    <div class="aspect-[3/2] sm:aspect-auto sm:h-full">
                                        <img src="{{ asset('images/dashboard/earthquake.png') }}" alt="Gempa Bumi" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                                    </div>
                                    <div class="absolute top-3 left-3">
                                ...
                                <div class="sm:w-3/5 p-5 sm:p-6 flex flex-col justify-center">
                                    <h3 class="font-bold text-white text-base sm:text-lg group-hover:text-emerald-400 transition-colors">Gempa Bumi</h3>
                                    <p class="text-sm text-slate-400 leading-relaxed mt-2 line-clamp-2">Gempa bumi terjadi akibat pergerakan lempeng tektonik. Ketahui prosedur perlindungan diri saat gempa.</p>
                                    <p class="text-xs text-slate-500 mt-2">Diperbarui: 5 Juni 2025</p>
                                    <a href="{{ route('guides.index') }}" class="inline-flex items-center gap-1.5 text-sm text-primary-600 font-semibold mt-3 hover:text-primary-700 transition-colors group/link">
                                        Lihat Selengkapnya
                                        <svg class="w-4 h-4 group-hover/link:translate-x-0.5 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                                    </a>
                                </div>
                        ...
                        <div class="card-fluid bg-white/[0.04] border border-white/[0.06] rounded-2xl shadow-card overflow-hidden group hover:bg-white/[0.07] transition-all duration-300">
                            <div class="flex flex-col sm:flex-row">
                                <div class="sm:w-2/5 relative overflow-hidden">
                                    <div class="aspect-[3/2] sm:aspect-auto sm:h-full">
                                        <img src="{{ asset('images/dashboard/volcano.png') }}" alt="Erupsi Gunung Api" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                                    </div>
                                    <div class="absolute top-3 left-3">
                                ...
                                <div class="sm:w-3/5 p-5 sm:p-6 flex flex-col justify-center">
                                    <h3 class="font-bold text-white text-base sm:text-lg group-hover:text-emerald-400 transition-colors">Erupsi Gunung Api</h3>
                                    <p class="text-sm text-slate-400 leading-relaxed mt-2 line-clamp-2">Erupsi gunung api menghasilkan lava, abu vulkanik, dan awan panas. Ketahui radius aman dan jalur evakuasi.</p>
                        ...
                        <div class="card-fluid bg-white/[0.04] border border-white/[0.06] rounded-2xl shadow-card overflow-hidden group hover:bg-white/[0.07] transition-all duration-300">
                            <div class="flex flex-col sm:flex-row">
                                <div class="sm:w-2/5 relative overflow-hidden">
                                    <div class="aspect-[3/2] sm:aspect-auto sm:h-full">
                                        <img src="{{ asset('images/dashboard/flood.png') }}" alt="Banjir Bandang" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                                    </div>
                                    <div class="absolute top-3 left-3">
                                        <span class="bg-sky-600/90 backdrop-blur-sm text-white text-[10px] font-semibold px-3 py-1 rounded-full">Hidrometeorologi</span>
                                    </div>
                                </div>
                                <div class="sm:w-3/5 p-5 sm:p-6 flex flex-col justify-center">
                                    <h3 class="font-bold text-white text-base sm:text-lg group-hover:text-emerald-400 transition-colors">Banjir Bandang</h3>
                                    <p class="text-sm text-slate-400 leading-relaxed mt-2 line-clamp-2">Banjir bandang datang dengan cepat tanpa peringatan. Pelajari langkah evakuasi dan persiapan darurat.</p>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-5 gap-6 animate-fade-up stagger-4">
                    ...
                    <section class="lg:col-span-3">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="flex gap-1.5">
                                <button @click="prevTip()" class="w-8 h-8 rounded-full bg-white/[0.06] border border-white/10 flex items-center justify-center text-slate-400 hover:text-emerald-400 hover:bg-white/[0.1] transition-all duration-200">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
                                </button>
                                <button @click="nextTip()" class="w-8 h-8 rounded-full bg-white/[0.06] border border-white/10 flex items-center justify-center text-slate-400 hover:text-emerald-400 hover:bg-white/[0.1] transition-all duration-200">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                                </button>
                            </div>
                        </div>

                        <div class="relative bg-white/[0.04] border border-white/[0.06] rounded-2xl shadow-card overflow-hidden" style="min-height: 180px;">
                    ...
                    <section class="lg:col-span-2">
                        ...
                        <div class="space-y-3">
                            {{-- Activity bubble 1 --}}
                            <div class="bg-white/[0.04] border border-white/[0.06] rounded-2xl p-4 hover:bg-white/[0.07] transition-all duration-300 flex items-center gap-3 group cursor-pointer">
                                <div class="w-10 h-10 rounded-xl bg-primary-100 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                                    <svg class="w-5 h-5 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z"/>
                                    </svg>
                                </div>
                                <div class="min-w-0">
                                    <p class="text-sm font-medium text-white truncate">Chat AI: "Cara evakuasi gempa"</p>
                            ...
                            {{-- Activity bubble 2 --}}
                            <div class="bg-white/[0.04] border border-white/[0.06] rounded-2xl p-4 hover:bg-white/[0.07] transition-all duration-300 flex items-center gap-3 group cursor-pointer">
                                <div class="w-10 h-10 rounded-xl bg-sky-100 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                            ...
                            {{-- Activity bubble 3 --}}
                            <div class="bg-white/[0.04] border border-white/[0.06] rounded-2xl p-4 hover:bg-white/[0.07] transition-all duration-300 flex items-center gap-3 group cursor-pointer">
                                <div class="w-10 h-10 rounded-xl bg-amber-100 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                            ...
                            {{-- Activity bubble 4 --}}
                            <div class="bg-white/[0.04] border border-white/[0.06] rounded-2xl p-4 hover:bg-white/[0.07] transition-all duration-300 flex items-center gap-3 group cursor-pointer">
                                <div class="w-10 h-10 rounded-xl bg-rose-100 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                ...
                <section class="animate-fade-up stagger-5">
                    <div class="flex items-center justify-between mb-5">
                        ...
                        <a href="{{ route('articles.index') }}" class="text-sm text-emerald-400 hover:text-emerald-300 font-semibold transition-colors flex items-center gap-1 group">
                            Lihat semua
                            <svg class="w-4 h-4 group-hover:translate-x-0.5 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                        </a>
                    </div>
                    ...
                    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 stagger-children">
                        ...
                        <a href="{{ route('articles.index') }}" class="group">
                            <div class="card-fluid bg-white/[0.04] border border-white/[0.06] rounded-2xl overflow-hidden hover:bg-white/[0.07] transition-all duration-300">
                                <div class="relative aspect-[4/3] overflow-hidden">
                                    <img src="{{ asset('images/dashboard/flood.png') }}" alt="Banjir Bandang" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                                    <div class="absolute inset-0 bg-gradient-to-t from-black/50 via-black/10 to-transparent"></div>
                                    <div class="absolute bottom-3 left-3 right-3">
                                        <span class="bg-white/20 backdrop-blur-sm text-white text-[9px] font-semibold px-2 py-0.5 rounded-full">BREAKING</span>
                                    </div>
                                </div>
                                <div class="p-3.5">
                                    <h3 class="font-semibold text-white text-xs sm:text-sm leading-snug line-clamp-2 group-hover:text-emerald-400 transition-colors">Banjir Bandang Melanda Kalimantan</h3>
                        ...
                        <a href="{{ route('articles.index') }}" class="group">
                            <div class="card-fluid bg-white/[0.04] border border-white/[0.06] rounded-2xl overflow-hidden hover:bg-white/[0.07] transition-all duration-300">
                                <div class="relative aspect-[4/3] overflow-hidden">
                                    <img src="{{ asset('images/dashboard/landslide.png') }}" alt="Tanah Longsor" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                                    <div class="absolute inset-0 bg-gradient-to-t from-black/50 via-black/10 to-transparent"></div>
                                </div>
                                <div class="p-3.5">
                                    <h3 class="font-semibold text-white text-xs sm:text-sm leading-snug line-clamp-2 group-hover:text-emerald-400 transition-colors">Angin Kencang dan Tanah Longsor di Jawa</h3>
                        ...
                        <a href="{{ route('articles.index') }}" class="group hidden lg:block">
                            <div class="card-fluid bg-white/[0.04] border border-white/[0.06] rounded-2xl overflow-hidden hover:bg-white/[0.07] transition-all duration-300">
                                ...
                                <div class="p-3.5">
                                    <h3 class="font-semibold text-white text-xs sm:text-sm leading-snug line-clamp-2 group-hover:text-emerald-400 transition-colors">Gempa M5.2 Guncang Sulawesi Utara</h3>
                                    <p class="text-[10px] sm:text-xs text-slate-400 mt-1.5 flex items-center gap-1">
                                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                                        Minggu, 5 Juni 2025
                                    </p>
                        ...
                        <a href="{{ route('articles.index') }}" class="group hidden lg:block">
                            <div class="card-fluid bg-white/[0.04] border border-white/[0.06] rounded-2xl overflow-hidden hover:bg-white/[0.07] transition-all duration-300">
                                <div class="relative aspect-[4/3] overflow-hidden">
                                    <img src="{{ asset('images/dashboard/volcano.png') }}" alt="Erupsi Gunung" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                                    <div class="absolute inset-0 bg-gradient-to-t from-black/50 via-black/10 to-transparent"></div>
                                </div>
                                <div class="p-3.5">
                                    <h3 class="font-semibold text-white text-xs sm:text-sm leading-snug line-clamp-2 group-hover:text-emerald-400 transition-colors">Aktivitas Gunung Merapi Meningkat</h3>
                                    <p class="text-[10px] sm:text-xs text-slate-400 mt-1.5 flex items-center gap-1">
                                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                                        Sabtu, 4 Juni 2025
                                    </p>
                ...
                <section class="animate-fade-up stagger-6 lg:hidden">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div class="bg-white/[0.04] border border-white/[0.06] rounded-2xl p-4 flex items-center gap-3 hover:bg-white/[0.07] transition-all duration-300">
