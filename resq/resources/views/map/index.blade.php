<x-app-layout>
    ...
    <div class="min-h-screen bg-slate-950 pb-24 lg:pb-0" x-data="mapDashboard()" x-cloak>
        ...
        <aside class="hidden lg:flex fixed top-0 left-0 h-full z-50 flex-col" x-data="{ sidebarHover: false }"
            ...
            <div class="h-full bg-slate-900/95 backdrop-blur-2xl border-r border-white/5 shadow-soft-lg flex flex-col py-6 sidebar-spring overflow-hidden"
                ...
                <div class="flex items-center gap-3 px-4 mb-8 overflow-hidden">
                    <div
                        class="w-10 h-10 rounded-2xl bg-gradient-to-br from-emerald-500 to-green-400 flex items-center justify-center shrink-0 shadow-md">
        ...
        <div class="lg:ml-[72px]">
            ...
            ============================================ --}}
            <section class="relative overflow-hidden glass-dark border-b border-white/5 pt-4" data-aos="fade-down"
                ...
                <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-6 sm:pt-8 sm:pb-8">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div class="flex items-center gap-4" data-aos="fade-right" data-aos-delay="200">
                            <div
                                class="w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-500 to-green-600 flex items-center justify-center shadow-lg shadow-emerald-500/20">
                            ...
                            <div>
                                ...
                                <p class="text-slate-400 text-sm mt-0.5">Pantau lokasi bencana di seluruh Indonesia
                                    secara real-time</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-3" data-aos="fade-left" data-aos-delay="300">
                            <span
                                class="inline-flex items-center gap-2 glass border border-white/10 px-4 py-2 rounded-full shadow-sm"
            ...
            <div class="max-w-[1920px] mx-auto p-4 sm:p-6 lg:p-8">
                <div class="flex flex-col lg:flex-row gap-6" style="height: calc(100vh - 200px); min-height: 600px;">
                    ...
                    FILTER PANEL
                    ======================== --}}
                    <div class="w-full lg:w-80 flex-shrink-0 flex flex-col glass-dark border border-white/5 rounded-2xl shadow-soft"
                        x-data="{ filterOpen: window.innerWidth >= 1024 }">
                        ...
                        <button @click="filterOpen = !filterOpen"
                            ...
                            <svg class="w-5 h-5 text-slate-400 transition-transform duration-300" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24" :class="filterOpen ? 'rotate-180' : ''">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        ...
                        <div x-show="filterOpen" x-transition:enter="transition ease-out duration-300"
                            ...
                            class="overflow-y-auto lg:h-full custom-scrollbar flex-1" style="max-height: 60vh;"
                            ...
                            <div class="p-5 space-y-5">
                                ...
                                <div class="bg-white/5 border border-white/10 rounded-xl p-4 shadow-sm">
                                    <label for="location-search"
                                        class="flex items-center gap-2 text-sm font-semibold text-white mb-3">
                                        <div
                                    ...
                                    <div class="flex gap-2">
                                        <div class="flex-1 relative">
                                            <input type="text" id="location-search" placeholder="Contoh: Jakarta..."
                                        ...
                                        <button id="search-btn"
                                            class="px-3.5 py-2.5 bg-gradient-to-r from-emerald-500 to-green-500 text-white rounded-xl shadow-lg shadow-emerald-500/20 hover:scale-[1.02] transition-all duration-200 active:scale-[0.98]"
                                            title="Cari">
                                    ...
                                    <p id="search-error"
                                        class="text-xs text-rose-400 mt-2 hidden flex items-center gap-1">
                                ...
                                <div class="bg-white/5 border border-white/10 rounded-xl p-4 shadow-sm">
                                    <label class="flex items-center gap-2 text-sm font-semibold text-white mb-3">
                                        <div
                                            class="w-7 h-7 rounded-lg bg-emerald-500/10 flex items-center justify-center border border-emerald-500/20">
                                    ...
                                    <div class="relative">
                                        <select id="radius-select"
                                            class="w-full bg-slate-900 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white appearance-none cursor-pointer focus:bg-slate-800 focus:ring-2 focus:ring-emerald-500 focus:outline-none transition-all duration-200 pr-10 shadow-inner">
                                        ...
                                        <div
                                            class="absolute inset-y-0 right-0 flex items-center px-3 text-slate-400 pointer-events-none">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M19 9l-7 7-7-7" />
                                            </svg>
                                ...
                                <div class="bg-white/5 border border-white/10 rounded-xl p-4 shadow-sm">
                                    <label class="flex items-center gap-2 text-sm font-semibold text-white mb-3">
                                        <div
                                            class="w-7 h-7 rounded-lg bg-amber-500/10 flex items-center justify-center border border-amber-500/20">
                                    ...
                                    <div class="space-y-1.5 max-h-44 overflow-y-auto pr-1 custom-scrollbar w-[101%]"
                                        id="disaster-type-filters">
                                        @foreach($disasterTypes as $type)
                                            <label
                                                class="flex items-center p-2.5 rounded-xl hover:bg-white/5 cursor-pointer transition-all duration-200 group mr-[2%]">
                                                ...
                                                <span
                                                    class="ml-2.5 text-sm text-slate-300 capitalize flex items-center gap-2 group-hover:text-white transition-colors">
                                                    @if($type === 'earthquake')
                                                        <span
                                                            class="w-5 h-5 rounded-lg bg-orange-500/20 flex items-center justify-center text-[10px] border border-orange-500/30">🌍</span>
                                                    @elseif($type === 'flood')
                                                        <span
                                                            class="w-5 h-5 rounded-lg bg-blue-500/20 flex items-center justify-center text-[10px] border border-blue-500/30">🌊</span>
                                                    @elseif($type === 'landslide')
                                                        <span
                                                            class="w-5 h-5 rounded-lg bg-amber-500/20 flex items-center justify-center text-[10px] border border-amber-500/30">⛰️</span>
                                                    @elseif($type === 'tsunami')
                                                        <span
                                                            class="w-5 h-5 rounded-lg bg-cyan-500/20 flex items-center justify-center text-[10px] border border-cyan-500/30">🌊</span>
                                                    @elseif($type === 'fire')
                                                        <span
                                                            class="w-5 h-5 rounded-lg bg-rose-500/20 flex items-center justify-center text-[10px] border border-rose-500/30">🔥</span>
                                                    @elseif($type === 'volcano')
                                                        <span
                                                            class="w-5 h-5 rounded-lg bg-red-500/20 flex items-center justify-center text-[10px] border border-red-500/30">🌋</span>
                                                    @else
                                                        <span
                                                            class="w-5 h-5 rounded-lg bg-slate-500/20 flex items-center justify-center text-[10px] border border-slate-500/30">⚠️</span>
                                                    @endif
                                                    {{ ucfirst($type) }}
                                                </span>
                                            </label>
                                ...
                                <div class="bg-white/5 border border-white/10 rounded-xl p-4 shadow-sm">
                                    <label class="flex items-center gap-2 text-sm font-semibold text-white mb-3">
                                        <div
                                            class="w-7 h-7 rounded-lg bg-rose-500/10 flex items-center justify-center border border-rose-500/20">
                                    ...
                                    <div class="space-y-1.5">
                                        <label
                                            class="flex items-center p-2.5 rounded-xl hover:bg-white/5 cursor-pointer transition-all duration-200 group">
                                            <input type="checkbox" name="severity" value="critical" checked
                                                class="w-4 h-4 rounded-lg bg-slate-900 border-white/20 text-rose-500 focus:ring-rose-500 cursor-pointer">
                                            <span
                                                class="ml-2.5 text-sm text-slate-300 flex items-center gap-2 group-hover:text-white transition-colors">
                                                <span
                                                    class="w-3 h-3 rounded-full bg-rose-500 shadow-[0_0_8px_rgba(244,63,94,0.6)]"></span>
                                        ...
                                        <label
                                            ...
                                            <input type="checkbox" name="severity" value="medium" checked
                                                class="w-4 h-4 rounded-lg bg-slate-900 border-white/20 text-amber-500 focus:ring-amber-500 cursor-pointer">
                                            <span
                                                class="ml-2.5 text-sm text-slate-300 flex items-center gap-2 group-hover:text-white transition-colors">
                                                <span
                                                    class="w-3 h-3 rounded-full bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.6)]"></span>
                                                <span class="font-medium">Sedang</span>
                                            </span>
                                        </label>
                                        <label
                                            class="flex items-center p-2.5 rounded-xl hover:bg-white/5 cursor-pointer transition-all duration-200 group">
                                            <input type="checkbox" name="severity" value="low" checked
                                                class="w-4 h-4 rounded-lg bg-slate-900 border-white/20 text-emerald-500 focus:ring-emerald-500 cursor-pointer">
                                            <span
                                                class="ml-2.5 text-sm text-slate-300 flex items-center gap-2 group-hover:text-white transition-colors">
                                                <span
                                                    class="w-3 h-3 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.6)]"></span>
                                ...
                                <div class="bg-white/5 border border-white/10 rounded-xl p-4 shadow-sm">
                                    <label class="flex items-center gap-2 text-sm font-semibold text-white mb-3">
                                        <div
                                            class="w-7 h-7 rounded-lg bg-purple-500/10 flex items-center justify-center border border-purple-500/20">
                                    ...
                                    <div class="space-y-2">
                                        <div class="relative dark-calendar">
                                            <input type="date" id="date-from"
                                                class="w-full bg-slate-900 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white focus:bg-slate-800 focus:ring-2 focus:ring-emerald-500 focus:outline-none shadow-inner">
                                        </div>
                                        <div class="flex items-center justify-center">
                                            <span
                                                class="text-[11px] font-semibold tracking-wider text-slate-500 uppercase">sampai</span>
                                        </div>
                                        <div class="relative dark-calendar">
                                ...
                                {{-- Stats Card --}}
                                <div class="bg-gradient-to-br from-emerald-950 to-slate-900 rounded-xl p-4 shadow-sm border border-emerald-500/20 relative overflow-hidden">
                                    <div
                                        class="absolute -right-10 -bottom-10 w-32 h-32 bg-emerald-500/10 rounded-full blur-2xl">
                                    </div>
                                    <h4
                                        class="text-sm font-semibold text-white mb-3 flex items-center gap-2 relative z-10">
                                        <div
                                            class="w-7 h-7 rounded-lg bg-emerald-500/20 flex items-center justify-center border border-emerald-500/30">
                                            <svg class="w-4 h-4 text-emerald-400" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <div class="grid grid-cols-2 gap-3 relative z-10">
                                        <div class="bg-slate-900/80 rounded-xl p-3 text-center border border-white/5">
                                            ...
                                            <div class="text-[10px] text-slate-400 font-medium mt-0.5">Total Bencana
                                            </div>
                                        </div>
                                        <div class="bg-slate-900/80 rounded-xl p-3 text-center border border-white/5">
                                            <div class="text-2xl font-bold text-emerald-400" id="visible-disasters">0
                                            </div>
                                ...
                                <button id="reset-filters"
                                    class="w-full flex items-center justify-center gap-2 px-4 py-3 bg-white/5 rounded-xl border border-white/10 text-sm font-medium text-slate-400 hover:text-emerald-400 hover:bg-white/10 hover:border-emerald-500/30 transition-all duration-300 active:scale-[0.98]">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    MAP CONTAINER
                    ======================== --}}
                    <div class="flex-1 relative rounded-2xl overflow-hidden glass-dark border border-white/5 shadow-soft"
                        data-aos="zoom-in" data-aos-delay="200">
                        <div id="map" class="w-full h-full min-h-[500px]"></div>

                        {{-- Loading Overlay --}}
                        <div id="map-loading"
                            class="absolute inset-0 bg-slate-900/80 backdrop-blur-md flex items-center justify-center hidden"
                            style="z-index: 9999;">
                            <div
                                class="flex flex-col items-center bg-slate-800 rounded-2xl shadow-2xl px-8 py-6 border border-white/20 ring-1 ring-black/50">
                                <div
                                    class="w-12 h-12 border-[3px] border-slate-600 border-t-emerald-500 rounded-full animate-spin">
                                </div>
                                <span class="mt-4 text-sm font-medium text-slate-300">Memuat rute dan data
                                    satelit...</span>
                            </div>
                        </div>

                        {{-- Auto-refresh Toggle --}}
                        <div class="absolute top-4 right-4 bg-slate-800/95 backdrop-blur-xl rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.5)] p-3.5 border border-white/20 hover:border-emerald-500/50 transition-all duration-300"
                            style="z-index: 9999;">
                        ...
                        {{-- Legend --}}
                        <div class="absolute bottom-4 left-4 lg:bottom-6 lg:left-6 bg-slate-800/95 backdrop-blur-xl rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.5)] p-4 border border-white/20"
                            style="z-index: 9999;">
                            <h4
                                class="text-[11px] font-bold text-slate-300 mb-3 flex items-center gap-1.5 uppercase tracking-wider">
                            ...
                            <div class="space-y-2">
                                <div
                                    class="flex items-center gap-2 bg-rose-500/10 rounded-lg px-2.5 py-1.5 border border-rose-500/20">
                                    <span
                                        class="w-3.5 h-3.5 rounded-full bg-rose-500 shadow-[0_0_8px_rgba(244,63,94,0.6)]"></span>
                                    <span class="text-[11px] font-semibold text-rose-300 uppercase tracking-wide">Tinggi
                                        / Kritis</span>
                                </div>
                                <div
                                    class="flex items-center gap-2 bg-amber-500/10 rounded-lg px-2.5 py-1.5 border border-amber-500/20">
                                    <span
                                        class="w-3.5 h-3.5 rounded-full bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.6)]"></span>
                                    <span
                                        class="text-[11px] font-semibold text-amber-300 uppercase tracking-wide">Sedang</span>
                                </div>
                                <div
                                    class="flex items-center gap-2 bg-emerald-500/10 rounded-lg px-2.5 py-1.5 border border-emerald-500/20">
                                    <span
                                        class="w-3.5 h-3.5 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.6)]"></span>
                                    <span
                                        class="text-[11px] font-semibold text-emerald-300 uppercase tracking-wide">Rendah</span>
                                </div>
                            </div>
                        </div>
                    </div>
