    ...
    <div class="min-h-screen bg-slate-950 pb-24 lg:pb-8" x-data="locationPicker()" x-cloak>
        ...
        <div class="lg:ml-[72px]">
            ...
            <section class="relative overflow-hidden glass-dark border-b border-white/5">
                <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-6 sm:pt-8 sm:pb-8">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold text-white">Tambah Lokasi Baru</h1>
                            <p class="text-slate-400 text-sm mt-0.5">Tambahkan lokasi untuk pemantauan risiko bencana</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                <form action="{{ route('locations.store') }}" method="POST" class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="glass-dark border border-white/5 rounded-2xl p-5">
                            ...
                            <p class="text-xs text-slate-400 mt-2">Berikan nama yang mudah diingat untuk lokasi ini</p>
                        </div>
                        ...
                        <div class="glass-dark border border-white/5 rounded-2xl p-5">
                            ...
                            <textarea name="address" x-model="address" rows="3"
                                      ...
                                      class="w-full bg-slate-800 border border-slate-600 rounded-xl px-4 py-3 text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500/50 resize-none"></textarea>
                        </div>
                        ...
                        <div class="glass-dark border border-white/5 rounded-2xl p-5">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="notifications_enabled" x-model="notificationsEnabled" value="1" class="sr-only peer" checked>
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-400 mt-2">Anda akan diberitahu jika ada bencana dalam radius ini</p>
                            </div>
                        </div>
                        ...
                        <div class="glass-dark border border-white/5 rounded-2xl p-5">
                            <div class="flex items-center justify-between">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="is_default" x-model="isDefault" value="1" class="sr-only peer">
                                    <div class="w-11 h-6 bg-slate-700 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-emerald-500"></div>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="lg:sticky lg:top-6 h-fit">
                        <div class="glass-dark border border-white/5 rounded-2xl p-5">
                            ...
                            <p class="text-xs text-slate-400 mt-3 text-center">Klik "Gunakan Lokasi Saat Ini" atau "Cari di Peta" untuk mengatur koordinat</p>
                        </div>

                        {{-- Quick Tips --}}
                        <div class="glass-dark border border-white/5 rounded-2xl p-5 mt-4">
                            ...
                            <ul class="space-y-2 text-sm text-slate-300">
                                <li class="flex items-start gap-2">
                                    ...
                                    <span>Simpan lokasi penting seperti rumah, kantor, atau tempat keluarga</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <span class="text-emerald-400">•</span>
                                    <span>Atur radius yang sesuai dengan area yang ingin Anda pantau</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <span class="text-emerald-400">•</span>
                                    <span>Pastikan nomor WhatsApp Anda tersimpan di profil untuk notifikasi</span>
                                </li>
                            </ul>
                        </div>
                    </div>
