...
<nav class="fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-slate-100 shadow-lg lg:hidden">
    <div class="flex items-center justify-around h-16 max-w-lg mx-auto px-2">
        {{-- Beranda --}}
        <a href="{{ route('dashboard') }}" class="flex flex-col items-center justify-center gap-0.5 {{ request()->routeIs('dashboard') ? 'text-primary-600' : 'text-slate-400 hover:text-primary-600' }} transition-colors min-w-[56px]">
        ...
        {{-- Peta --}}
        <a href="{{ route('map.index') }}" class="flex flex-col items-center justify-center gap-0.5 {{ request()->routeIs('map.*') ? 'text-primary-600' : 'text-slate-400 hover:text-primary-600' }} transition-colors min-w-[56px]">
        ...
        <a href="{{ route('ai-assist.index') }}" class="flex flex-col items-center justify-center -mt-5">
            <div class="w-14 h-14 rounded-full bg-gradient-to-br from-primary-500 to-primary-700 flex items-center justify-center shadow-lg shadow-primary-500/30 ring-4 ring-white hover:shadow-lg hover:shadow-primary-600/40 transition-all duration-300">
        ...
        {{-- Artikel --}}
        <a href="{{ route('articles.index') }}" class="flex flex-col items-center justify-center gap-0.5 {{ request()->routeIs('articles.*') ? 'text-primary-600' : 'text-slate-400 hover:text-primary-600' }} transition-colors min-w-[56px]">
        ...
        {{-- Profil --}}
        <a href="{{ route('profile.edit') }}" class="flex flex-col items-center justify-center gap-0.5 {{ request()->routeIs('profile.*') ? 'text-primary-600' : 'text-slate-400 hover:text-primary-600' }} transition-colors min-w-[56px]">
